...
const newRotation1 = 0.5 * width - 150;
carousel1.style.transform = "translate3d(" + newRotation1 + "px, 0px, 0px)";
const newPerspective1 = 450 + 900 * selectedIndex1;
carousel1.style.perspectiveOrigin = newPerspective1 + "px 50%";
...
function rotateCarousel1() {
  ...
  carousel1.style.transform = "translate3d(" + newRotation + "px, 0px, 0px)";
...
carousel2.style.transform = "translate3d(" + newRotation2 + "px, 0px, 0px)";
...
function rotateCarousel2() {
  ...
  carousel2.style.transform = "translate3d(" + newRotation + "px, 0px, 0px)";
...
carousel3.style.transform = "translate3d(" + newRotation3 + "px, 0px, 0px)";
...
function rotateCarousel3() {
  ...
  carousel3.style.transform = "translate3d(" + newRotation + "px, 0px, 0px)";
