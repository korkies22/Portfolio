...
const projects={
  project1:{
    name:'Grupos',
    description:'A web application made in order to allow people to join interest groups and programm meetings in different spaces of the city',
    img:'../images/grupos.png',
    link:'https://github.com/Uniandes-ISIS2603-backup/201720-s1_grupos'
  },
  project2:{
    name:'Yale',
    description:'An entire system architecture design for a smart lock company. Build in mind to withstand 300.000 requests per minute in the worst case',
    img:'../images/yale.png',
    link:'https://github.com/ISIS2503/201810_02_pipo'
  },
  project3:{
    name:'OwO',
    description:'A mobile application designed in order to facilitate students plan their study times and connect them with the university systems',
    img:'../images/OwO.png',
    link:'https://gitlab.com/ISIS3510_201810_Team2/Android'
  },
  project4:{
    name:'GM',
    description:'A mobile application which allowed people to ask questions about cars they scan with a QR code',
    img:'../images/gm.png',
    link:'https://github.com/julypriets/Android-gm'
  },
  project5:{
    name:'Podometer',
    description:'A podometer designed with an Arduino so that it counts every time the person makes a step',
    img:'../images/podometer.png',
    link:null
  },
  project6:{
    name:'Yale',
    description:'An Arduino project in order to simulate an Smart Lock. It had more than 3 different kinds of sensors',
    img:'../images/yaleArduino.png',
    link:'https://github.com/ISIS2503/201810_02_pipo/tree/master/entidadFisica'
  },
  project7:{
    name:'Thermostated Bath',
    description:'A thermostated bath created to heat microfluidic systems up to 50°C in a controlled manner',
    img:'../images/bath.png',
